...
<table>
  ...
  <tr>
    ...
    <td>Let $\operatorname{Lev}(\cdot,\cdot)$ be token-level Levenshtein distance and define normalized similarity $\operatorname{LevSim}(a,b)=1-\dfrac{\operatorname{Lev}(a,b)}{\max(\lVert a\rVert,\lVert b\rVert)}$. Then $d(a,b)=1-\operatorname{LevSim}(a,b)=\dfrac{\operatorname{Lev}(a,b)}{\max(\lVert a\rVert,\lVert b\rVert)}.$</td>
  </tr>
  <tr>
