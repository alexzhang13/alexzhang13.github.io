...
Right now, I'm particularly interested in systems for/in ML, scaling and understanding language models, and applications of AI to the natural sciences! The most recent projects (+ research) I've led / majorly contributed to are:
...
<li> <a href="https://arxiv.org/abs/2402.01695">World models that can be conditioned on language </a> for model-based agents. </li>
<li> <a href="https://arxiv.org/abs/2410.03859">Multi-modal task instances for SWEBench</a> with the original authors. </li>
<li> <a href="https://github.com/alexzhang13/flashattention2-custom-mask">Simple FlashAttention2 with custom masks</a> in Triton. </li>
</ul>
